...
<section>
    ...
    <div class="z-1 relative bg-white w-[695px] h-screen ml-auto rounded-l-[50px] shadow-[0px_0px_100px_0px_rgba(0,0,0,0.25)]">
        ...
        <div class="right-[128px] mt-[200px] absolute text-start h-[582px] w-[440px]">
            ...
            <form method="POST" action="/signup" class="font-Host text-base font-normal mt-8">
            ...
            <div class="mt-[19px]">
                ...
                <a href="/" class="bg-[#DA0700] w-full h-[46px] rounded-full text-white font-bold text-lg font-Host  flex items-center justify-center">
