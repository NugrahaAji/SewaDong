    ...
    <section class="h-[100vh]">
        ...
        <div class="z-1 relative bg-white w-[1357px] h-screen ml-auto rounded-l-[50px] shadow-[0px_0px_100px_0px_rgba(0,0,0,0.25)]">
            <div class="absolute mt-[160px] w-full max-w-[1027px]">
                ...
                <div class="w-full max-w-[1027px] mt-[20px] ml-[160px] flex-row">
                    <label
                    for="dropzone-file" id="dropzone" class="flex flex-col items-center justify-center w-full h-[560px] border border-[#989898] rounded-lg cursor-pointer text-black transition-colors duration-200 overflow-hidden font-Host">
                ...
                <div id="file-preview" class="mt-4 text-text-[16px] text-gray-700 space-y-1"></div>

                    <button class="mt-6 bg-[#DA0700] w-[160px] h-[46px] rounded-full text-white font-bold text-lg font-Host">
                        Kirim
                    </button>
                </div>
            </div>
