    ...
    <header class="flex-col justify-between fixed w-full shadow-[0px_0px_50px_0px_rgba(0,0,0,0.03)] z-100 top-20 bg-white pb-1">
        <div class="flex justify-center my-4">
            <ul class="font-Host text-lg font-normal flex gap-12 text-[#989898]">
                <li class="hover:text-[#070707]"><a href="/kategori-barang">Barang</a></li>
                <li class="hover:text-[#070707] text-[#070707]"><a href="/kategori-jasa">Jasa</a></li>
            </ul>
        </div>
        ...
        <div class="flex justify-between mx-40 mt-[14px]">
            <ul class="flex gap-[26px]">
                ...
                <li><button class="opacity-45 hover:opacity-100 focus:opacity-100"><img src="{{ url('icon/mc.svg') }}" ></button></li>
                <li><button class="opacity-45 hover:opacity-100 focus:opacity-100"><img src="{{ url('icon/eo.svg') }}" ></button></li>
                <li><button class="opacity-45 hover:opacity-100 focus:opacity-100"><img src="{{ url('icon/photo.svg') }}" ></button></li>
                <li><button class="opacity-45 hover:opacity-100 focus:opacity-100"><img src="{{ url('icon/video.svg') }}" ></button></li>
            </ul>
