...
<body class="">
    ...
    <section>
        ...
        <div class ="-z-10 absolute top-0">
            <img src="{{ url('image/bg-beranda.svg') }}" alt="">
        </div>

        <!-- Produk Section -->
        <div class="z-1 relative bg-white h-fit mt-[577px] rounded-t-[50px] shadow-[0px_0px_100px_0px_rgba(0,0,0,0.25)]">
            <div class="mx-40 pt-3">
                <ul class="justify-between flex items-center">
                    <li class="text-2xl font-Host font-normal cursor-default">Produk unggulan</li>
                    <li class="font-normal font-host">
                        <label for="search">
            ...
            <div class="h-[1080px] mt-5">
                <img src="{{ url('icon/sewadong.svg') }}" alt="">
                <img src="{{ url('icon/sewadong2.svg') }}" alt="" class="mb-16">
